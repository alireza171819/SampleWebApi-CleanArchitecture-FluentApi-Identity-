...
public interface IOrderService
{
    ...
    /// </list>
    /// </returns>
    Task<Result> Create(CreateOrderDto createOrderDto, CancellationToken cancellationToken);

    /// <summary>
    /// Update an existing order.
    /// <param name="updateOrderDto">DTO containing the order ID and fields to update (UserId, OrderDate, ShippedDate, ShipAddress, Uuid).</param>
    ...
    /// </list>
    /// </returns>
    Task<Result> Update(UpdateOrderDto updateOrderDto, CancellationToken cancellationToken);

    /// <summary>
    /// Deletes an order by its identifier.
    /// </summary>
    /// <param name="deleteOrderDto">DTO containing the ID of the order to delete.</param>
    ...
    /// </list>
    /// </returns>
    Task<Result> Delete(OrderByIdDto deleteOrderDto, CancellationToken cancellationToken);

    /// <summary>
    /// Retrieves a single order by its unique identifier.
    /// </summary>
    /// <param name="getByIdOrder">DTO containing the order ID to fetch.</param>
    /// <param name="cancellationToken">Token to cancel the operation.</param>
    /// <returns>
    /// A standardized result containing:
    /// <list type="bullet">
    ...
    /// </list>
    /// </returns>
    Task<Result<SingleOrderDto>> GetById(OrderByIdDto getByIdOrder, CancellationToken cancellationToken);
    ...
    /// </returns>
    Task<Result<ListOrderDto>> GetAll(CancellationToken cancellationToken);
}
