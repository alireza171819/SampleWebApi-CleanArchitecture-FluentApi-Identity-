...
public class Result : Result<Result>
{
    ...
    /// A failed result.
    /// </returns>
    public new static Result Failure(string errorMessage, ResultStatus status) => new(false, errorMessage, status);
    ...
    /// </returns>
    public new static Result NotFound(string errorMessage) => new(false, errorMessage, ResultStatus.NotFound);
    ...
    /// </summary>
    /// <param name="validationErrorsMessage">A list of validation errors encountered</param>
    /// <returns>A Result<typeparamref name="T"/></returns>
    public new static Result Invalid(string validationErrorsMessage) => new(false, validationErrorsMessage, ResultStatus.Invalid);
}
